...
const date = new Date(TERMS_VERSION + 'T00:00:00');
export const metadata: Metadata = {
  title: 'Terms and Conditions - Retinentia',
};
    ...
    <div className={styles.privacy_and_terms_container}>
      <div className={styles.terms_and_conditions_container}>
        ...
        <p>
          ...
          <span>&nbsp;refers to: New York, United States</span>
        </p>
        <p>
          <strong>
            <span>Company</span>
        ...
        <p>
          ...
          <span>
            ...
            that can be posted, uploaded, linked to or otherwise made available
        ...
        <p>
          ...
          <span>&nbsp;refers to Retinentia, accessible from&nbsp;</span>
          <a href='https://retinentia.com'>
            <span>https://retinentia.com</span>
          </a>
        </p>
        <p>
          <strong>
        ...
        <h3>
          <span>Your Right to Post Content</span>
        </h3>
        <p>
          <span>
        ...
        <ul>
          <li>
            <span>Unlawful or promoting unlawful activity.</span>
          </li>
          <li>
            <span>
          ...
          <li>
            <span>Violating the privacy of any third person.</span>
          </li>
          <li>
            <span>False information and features.</span>
          </li>
        </ul>
        <p>
          <span>
        ...
        <p>
          <span>
            ...
            our copyright agent via email at support@retinentia.com and include
        ...
        <p>
          <span>
            ...
            support@retinentia.com. Upon receipt of a notification, the Company
        ...
        <div>
          <ul>
            <li>
              <span>
                By email:{' '}
                <a href='mailto:support@retinentia.com'>
                  support@retinentia.com
                </a>
              </span>
            </li>
          </ul>
        ...
        <div className='fadeout_footer'></div>
      </div>
    </div>
  );
};
